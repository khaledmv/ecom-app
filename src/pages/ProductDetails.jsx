        ...
        <section>
          ...
          <div className="flex flex-wrap justify-around">
            ...
            <div className="max-w-xl my-3 text-left">
              ...
              <p className="my-3">
                {! inCart && <button onClick={() => addToCart(product)} className="inline-flex items-center py-2 px-5 mr-5 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 disabled:bg-gray-300 " disabled={product.in_stock? "": "disabled"}>Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button>} 
              ...
              <p className="text-lg text-left text-gray-900 dark:text-slate-200">
