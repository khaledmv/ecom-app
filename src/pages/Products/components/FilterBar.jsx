                  ...
                  <ul className="text-slate-700 dark:text-slate-100">
                    ...
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          ...
                          <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars </label>
                      </div>
                      <div className="flex items-center my-1">
                          ...
                          <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars </label>
                      </div>
                      <div className="flex items-center my-1">
                          ...
                          <label htmlFor="rating-sort-4" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">1 Stars</label>
                      </div>
                    </li>
                    <li className="mt-1 mb-5 ">
                      ...
                      <div className="flex items-center my-1">
                          ...
                          <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 cursor-pointer">Best Seller Only</label>
                      </div>
                      <div className="flex items-center my-1">
                          ...
                          <label htmlFor="only-instock" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 cursor-pointer">INSTOCK Only</label>
                      </div>
                    </li>
