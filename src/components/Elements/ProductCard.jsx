...
export const ProductCard = ({product}) => {
    ...
    const { id, name, overview, poster, image_local, price,best_seller, rating} = product;
    ...
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
            ...
            <p className="flex justify-between items-center">
                ...
                { !inCart && <button onClick={() => addToCart(product)} className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 disabled:bg-gray-300 disabled:text-gray-600" disabled={product.in_stock? "": "disabled"} >{product.in_stock ? "Add To Cart ": "Out of Stock"}<i className="ml-1 bi bi-plus-lg"></i></button>}
